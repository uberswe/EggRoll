...
namespace PhoneApp1
{
    ...
    class Weather
    {
        ...
        public Weather(int updateIntervalInMinutes)
        {
            ...
            this.updateIntervalInMilliseconds = (updateIntervalInMinutes * 1000) * 60;
            Update();
        }
        ...
        private void Update()
        {
            Thread UpdatePositionThread = new Thread(new ThreadStart(UpdatePosition));
        }
