...
namespace Egg_roll
{
    public class MainScene
    {
        ...
        {
            DrawRect = new Rectangle((int)player.Position.X - graphics.PreferredBackBufferWidth - 150, (int)player.Position.Y - graphics.PreferredBackBufferHeight, (graphics.PreferredBackBufferWidth *2) + 300, graphics.PreferredBackBufferHeight * 2);
